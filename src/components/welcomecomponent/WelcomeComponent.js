...
function WelcomeComponent({ changeScreen, signin }) {
                ...
                <div className="col_text col-md-5">
                    <div className="d-flex mx-auto">
                        <div className="text__wrapper">
                            ...
                            <button onClick={() => signin()} className="btn btn-primary join_prime ">Join Prime</button>
                        </div>
                    </div>
                </div>
                ...
                <div className="col_text col-md-6">
                    <div className="d-flex mx-auto">
                        <div className="text__wrapper">
                            ...
                            <button onClick={() => signin()} className="join_prime btn btn-primary">Get Started</button>
                        </div>
                    </div>
                </div>
                ...
                <div className=" col_text col-md-5">
                    <div className="d-flex mx-auto">
                        <div className="text__wrapper">
                            ...
                            <button onClick={() => signin()} className="btn btn-primary join_prime ">Get Started</button>
                        </div>
                    </div>
                </div>
